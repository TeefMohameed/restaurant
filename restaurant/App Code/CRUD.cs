   ...
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["Helah7685aConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["Helah7685aConStr"].ConnectionString);
        public CRUD()
        {
            //
        ...
        internal object ExecuteScalar(string mySql, Dictionary<string, object> myPara)
        {
        ...
        internal DataTable GetDataTable(string mySql)
        {
            throw new NotImplementedException();
        }
